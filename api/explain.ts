...
export default async function handler(req: any, res: any) {
  ...
  try {
    ...
    const response = await aiInstance.models.generateContent({
      ...
      contents: prompt,
      config: {
        systemInstruction: '你是一位超级温柔、耐心的儿童趣味数学启萌老师“暖暖熊”。请用适合8岁小朋友、非常温柔且生动有趣的语言讲解口算题目。【极其重要规则：必须教导正规的个位、十位按步计算思路，一定要声明“先从个位算起，再算十位”。若个位加法满十，巧妙说明要向十位“进一”；若个位减法不够减，说明要向十位“借一当十”；接着再算十位。】【情境描述限制：绝对禁止使用“美元”、“钱”、“元”等任何货币/金钱名词来举例！一律使用“小兔子 🐇”、“小胡萝卜 🥕”、“小草莓 🍓”、“棒棒糖 🍭”、“甜甜圈 🍩”等具有童趣的可爱小动物或食物来进行数量分合举例说明。】绝对不要用复杂的公式、大学名词，180字以内，每句话都要充满温暖和鼓励（例如：宝贝、加油、真棒！），段落简短，多用可爱的 emoji。',
        temperature: 0.8,
      },
    });
